...
function init_gear_sets()
    ...
    sets.precast.BloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Sancus Sachet +1",
        ...
        body="Con. Doublet +2",hands="Convoker's Bracers +1",ring1="Defending Ring",ring2="Evoker's Ring",
    ...
    sets.midcast.Pet.DebuffBloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Sancus Sachet +1",
        head="Convoker's Horn +1",neck="Caller's Pendant",ear1="Andoaa Earring",ear2="Enmerkar Earring",
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {main="Gridarvor",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        ...
        body="Con. Doublet +2",hands="Merlinic Dastanas",ring1="Varar Ring +1",ring2="C. Palug Ring",
        back=gear.phys_jse_back,waist="Incarnation Sash",legs={ name="Apogee Slacks +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}},feet="Helios Boots"}
    ...
    sets.midcast.Pet.MagicalBloodPactRage = {main="Espiritus",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        ...
        body="Apo. Dalmatica +1",hands="Merlinic Dastanas",ring1="Varar Ring +1",ring2="Varar Ring +1",
        back="Campestres's Cape",waist="Regal Belt",legs={ name="Apogee Slacks +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}},feet={ name="Apogee Pumps +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}}}
	...
	sets.midcast.Pet['Flaming Crush'] = {main="Gridarvor",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        head="Helios Band",neck="Shulmanu Collar",ear1="Gelos Earring",ear2="Lugalbanda Earring",
        body="Apo. Dalmatica +1",hands="Merlinic Dastanas",ring1="Varar Ring +1",ring2="Varar Ring +1",
        back="Campestres's Cape",waist="Regal Belt",legs={ name="Apogee Slacks +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}},feet={ name="Apogee Pumps +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}}}
    ...
    sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum",
        head="Beckoner's Horn +1",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="C. Palug Earring",
	...
	sets.idle.Town = set_combine(sets.idle, {main="Gridarvor", sub="Elan Strap +1",ammo="Sancus Sachet +1"})
    ...
    sets.idle.Avatar = {main="Gridarvor",sub="Oneiros Grip",ammo="Sancus Sachet +1",
        ...
        back=gear.phys_jse_back,waist="Lucidity Sash",legs="Assid. Pants +1",feet="Inyan. Crackows +2"}
    ...
    -- Normal melee group
    sets.engaged = {main="Gridarvor",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        head="Beckoner's Horn +1",neck="Shulmanu Collar",ear1="Cessance Earring",ear2="Telos Earring",
        body="Tali'ah Manteel",hands="",ring1="Hetairoi Ring",ring2="Petrov Ring",
