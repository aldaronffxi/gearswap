function get_sets()
	...
	sets.crafting.cloth = {main="Murgleis",sub="Pl. Escutcheon",
	head="Magnifying Specs.",neck="Weaver's Torque",
	body="Weaver's Apron",ring1="Orvail Ring +1",ring2="Craftmaster's Ring"}
