function user_job_setup()
	...
	state.Weapons:options('None','Lathi','BurstWeapons')
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.BurstWeapons = {main="Lathi",sub="Enki Strap"}
    ...
    sets.precast.FC = {ammo="Impatiens",
		head="Amalric Coif +1",neck="Orunmila's Torque",ear1="Etiolation Earring",ear2="Malignance Earring",
    ...
    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {ring2="Prolix Ring",back=gear.fc_jse_back,})
    ...
    sets.precast.WS['Vidohunir'] = {ammo="Dosis Tathlum",
		...
		back=gear.nuke_jse_back,waist="Fotia Belt",legs="Hagondes Pants +1",feet="Jhakri Pigaches +2"}
    ...
    sets.midcast.Stun = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Hasty Pinion +1",
        ...
        body="Zendik Robe",hands="Nyame Gauntlets",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
    ...
    sets.midcast['Elemental Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Ea Hat +1",neck="Src. Stole +2",ear1="Regal Earring",ear2="Friomisi Earring",
        body="Amalric Doublet +1",hands="Amalric Gages +1",ring1="Freke Ring",ring2="Shiva Ring +1",
        back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Amalric Slops +1",feet="Jhakri Pigaches +2"}
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        ...
        back=gear.nuke_jse_back,waist="Yamabuki-no-Obi",legs="Merlinic Shalwar",feet="Jhakri Pigaches +2"}

	sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {main="Lathi",sub="Enki Strap",ammo="Pemphredo Tathlum",ear1="Malignance Earring",ear2="Regal Earring",hands="Amalric Gages +1",ring2="Metamor. Ring +1",back=gear.nuke_jse_back,feet="Jhakri Pigaches +2"})
    ...
    sets.idle = {main="Daybreak",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		...
		back="Umbra Cape",waist="Flax Sash",legs="Assid. Pants +1",feet="Nyame Sollerets"}
    ...
    sets.MagicBurst = {ammo="Pemphredo Tathlum",
        ...
        body="Ea Houppelande +1",hands="Amalric Gages +1",ring1="Freke Ring",ring2="Mujin Band",
        back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Ea Slops +1",feet="Amalric Nails +1"}
