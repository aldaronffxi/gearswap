...
function user_job_setup()
	...
	state.Weapons:options('Default','DualSavage','DualFomalhaut','DualGastra','DualArmageddon')
	
	WeaponType =  {['Armageddon'] = "Gun",
                   ['Fomalhaut'] = "Gun",
				   ['Anarchy +2'] = "Gun",
	...
	gear.dw_ranger_jse_back = { name="Belenus's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dual Wield"+10','Phys. dmg. taken-10%',}}
	gear.strwsd_ranger_jse_back = { name="Belenus's Cape", augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
	gear.agiwsd_ranger_jse_back = { name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Weapon skill damage +10%',}}
	gear.rtp_ranger_jse_back = { name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','"Store TP"+10',}}
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.Default = {main="Kustawi +1",sub="Kustawi +1"}
	sets.weapons.DualSavage = {main="Naegling",sub="Gleti's Knife",range="Sparrowhawk +2"}
	sets.weapons.DualFomalhaut = {main="Perun +1",sub="Blurred Knife +1",range="Fomalhaut"}
	sets.weapons.DualGastra = {main="Tauret",sub="Kraken Club",range="Gastraphetes"}
	sets.weapons.DualArmageddon = {main="Gleti's Knife",sub="Kraken Club",range="Armageddon"}
	
	
	-- Precast sets to enhance JAs
	sets.TreasureHunter = {head=gear.th_head,waist=gear.th_waist,hands=gear.th_hands}
    ...
    sets.precast.WS = {
        ...
        back=gear.agiwsd_ranger_jse_back,waist="Fotia Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.precast.WS['Savage Blade'] = {ammo="Hauksbok Arrow",
        ...
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Regal Ring",ring2="Epaminondas's Ring",
        back=gear.strwsd_ranger_jse_back,waist="Sailfi Belt +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
		
    sets.precast.WS['Last Stand'] = {ammo="Quelling Bolt",
        head="Nyame Helm",neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Ishvara Earring",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Regal Ring",ring2="Epaminondas's Ring",
        back=gear.agiwsd_ranger_jse_back,waist="Fotia Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.precast.WS['Wildfire'] = {ammo="Chrono Bullet",
        ...
        back=gear.agiwsd_ranger_jse_back,waist="Orpheus's Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}
		
    sets.precast.WS['Hot Shot'] = {ammo="Chrono Bullet",
        head="Nyame Helm",neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Friomisi Earring",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Dingir Ring",ring2="Epaminondas's Ring",
        back=gear.agiwsd_ranger_jse_back,waist="Orpheus's Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}
		
    sets.precast.WS['Trueflight'] = {ammo="Quelling Bolt",
        head="Nyame Helm",neck="Scout's Gorget +2",ear1="Moonshade Earring",ear2="Friomisi Earring",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Dingir Ring",ring2="Epaminondas's Ring",
        back=gear.agiwsd_ranger_jse_back,waist="Orpheus's Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}
		
    sets.precast.WS['Aeolian Edge'] = {ammo="Quelling Bolt",
        head="Nyame Helm",neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Friomisi Earring",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Dingir Ring",ring2="Epaminondas's Ring",
        back=gear.agiwsd_ranger_jse_back,waist="Orpheus's Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.engaged.DW = {
		...
		body="Tatena. Harama. +1",hands="Tatena. Gote +1",ring1="Epona's Ring",ring2="Hetaroi Ring",
		back=gear.dw_ranger_jse_back,waist="Windbuffet Belt +1",legs="Tatena. Haidate +1",feet="Tatena. Sune. +1"}
		
    sets.engaged.DW.Hybrid = {
		head="Malignance Chapeau",neck="Iskur Gorget",ear1="Suppanomimi",ear2="Telos Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Chirich Ring +1",ring2="Chirich Ring +1",
		back=gear.dw_ranger_jse_back,waist="Windbuffet Belt +1",legs="Malignance Tights",feet="Malignance Boots"}
    ...
    sets.engaged.DW.Acc = {
		...
		back=gear.dw_ranger_jse_back,waist="Olseni Belt",legs="Meg. Chausses +2",feet="Malignance Boots"}
    ...
    sets.midcast.RA = {
        head="Malignance Chapeau",neck="Scout's Gorget +2",ear1="Enervating Earring",ear2="Telos Earring",
	...
	sets.buff.Barrage = {hands="Orion Bracers +3",ammo="Quelling Bolt",}
	...
	sets.idle.Town = set_combine(sets.idle, {body="Nisroch Jerkin",neck="Scout's Gorget +2",waist="Orpheus's Sash",legs="Carmine Cuisses +1",})
