...
function init_gear_sets()
	...
	-- CURING WALTZ
	sets.precast.Waltz = {
		head=gear.valorous_pet_head,neck="Adad Amulet",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
	...
	sets.precast.FC = {ammo="Impatiens",
		...
		body="Nyame Mail",hands="Leyline Gloves",ring1="Kishar Ring",ring2="Prolix Ring"}
	...
	sets.midcast.FastRecast = {
		...
		back="Moonlight Cape",waist="Klouskap Sash",legs="Nyame Flanchard",feet="Tot. Gaiters +1"}

	sets.midcast.Utsusemi = set_combine(sets.midcast.FastRecast, {back="Mujin Mantle"})

	sets.midcast.Cure = {
		head="Gavialis Helm",neck="Phalaina Locket",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Lebeche Ring",ring2="Janniston Ring",
		back="Pastoralist's Mantle",waist="Klouskap Sash",legs="Nyame Flanchard",feet="Tot. Gaiters +1"}
	...
	sets.precast.WS['Primal Rend'] = {ammo="Dosis Tathlum",
		...
		body="Nyame Mail",hands="Leyline Gloves",ring1="Shiva Ring +1",ring2="Shiva Ring +1",
		back="Toro Cape",waist="Fotia Belt",legs="Nyame Flanchard",feet="Tot. Gaiters +1"}
	...
	sets.midcast.Pet.WS = {main=gear.PHYKumbha1,sub=gear.PHYKumbha2,ammo="Voluspa Tathlum",
		head="Nyame Helm",neck="Shulmanu Collar",ear1="Enmerkar Earring",ear2="Domesticator's Earring",
	...
	sets.midcast.Pet.SomeAcc = sets.midcast.Pet.WS
	sets.midcast.Pet.Acc = sets.midcast.Pet.WS
	sets.midcast.Pet.FullAcc = sets.midcast.Pet.WS
	...
	sets.idle = {main="Izizoeksi",sub=gear.PDTMABKumbha,ammo="Staunch Tathlum +1",
		head="Nyame Helm",neck="Adad Amulet",ear1="Sanare Earring",ear2="Tuisto Earring",
		body="Sacro Breastplate",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="C. Palug Ring",
		back="Solemnity Cape",waist="Asklepian Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
	...
	sets.idle.Pet = {main="Izizoeksi",sub=gear.PDTMABKumbha,ammo="Voluspa Tathlum",
		head="Anwig Salade",neck="Adad Amulet",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
		body="Tot. Jackcoat +3",hands="Ankusa Gloves +1",ring1="Defending Ring",ring2="C. Palug Ring",
		back="Artio's Mantle",waist="Isa Belt",legs="Nyame Flanchard",feet="Ankusa Gaiters +3"}
	...
	sets.defense.PDT = {ammo="Staunch Tathlum +1",
		head="Tuisto Kabuto",neck="Adad Amulet",ear1="Sanare Earring",ear2="Handler's Earring +1",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="C. Palug Ring",
		back="Moonlight Cape",waist="Asklepian Belt",legs="Nyame Flanchard",feet="Nukumi Ocreae +1"}

	sets.defense.PetPDT = {ammo="Voluspa Tathlum",
		head="Anwig Salade",neck="Adad Amulet",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
		body="Tot. Jackcoat +3",hands="Ankusa Gloves +1",ring1="Defending Ring",ring2="C. Palug Ring",
		back="Pastoralist's Mantle",waist="Isa Belt",legs="Nyame Flanchard",feet="Ankusa Gaiters +3"}
	...
	sets.defense.MDT = {ammo="Staunch Tathlum +1",
		head="Tuisto Kabuto",neck="Warder's Charm +1",ear1="Sanare Earring",ear2="Etiolation Earring",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Shadow Ring",
		back="Engulfer Cape +1",waist="Engraved Belt",legs="Nyame Flanchard",feet="Nukumi Ocreae +1"}

	sets.defense.MEVA = {
		head="Gavialis Helm",neck="Warder's Charm +1",ear1="Sanare Earring",ear2="Etiolation Earring",
		body="Nyame Mail",hands="Leyline Gloves",ring1="Vengeful Ring",ring2="Purity Ring",
	...
	sets.Kiting = {feet="Nyame Sollerets"}
	sets.DayIdle = {}
	sets.NightIdle = {}
	...
	sets.engaged.PDT = {ammo="Staunch Tathlum +1",
		head="Tuisto Kabuto",neck="Adad Amulet",ear1="Brutal Earring",ear2="Sherida Earring",
		body="Nyame Mail",hands="Buremte Gloves",ring1="Defending Ring",ring2="Dark Ring",
		back="Moonlight Cape",waist="Asklepian Belt",legs="Meg. Chausses +2",feet="Valorous Greaves"}
	...
	sets.engaged.Acc.PDT = {ammo="Falcon Eye",
		head=gear.valorous_wsd_head,neck="Adad Amulet",ear1="Brutal Earring",ear2="Sherida Earring",
		body="Nyame Mail",hands="Buremte Gloves",ring1="Defending Ring",ring2="Dark Ring",
		back="Moonlight Cape",waist="Asklepian Belt",legs="Meg. Chausses +2",feet="Valorous Greaves"}
