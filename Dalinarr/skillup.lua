...
user_settings = {
    user_spells = {
        Healing = T{'Cure'},
        Geomancy = T{},
        Enhancing = T{'Barstone','Barfire','Barwater'},
        Ninjutsu = T{},
        Singing = T{},
        Blue = T{},
        Summoning = T{}},
...
function status_change(new,old)
    ...
    if new=='Idle' then
        if skilluprun then
            send_command('wait 1.0;input /ma "'..gs_skill.skillup_spells[gs_skill.skillup_count]..'" <t>')
        end
...
function filtered_action(spell)
    ...
    if gs_skill.bluspellulid[spell.en] then
        ...
        elseif windower.ffxi.get_ability_recasts()[254] and windower.ffxi.get_ability_recasts()[254] == 0 then
            ...
            send_command('input /ma "'..gs_skill.skillup_spells[gs_skill.skillup_count]..'" <t>')
        end
        return
...
function aftercast(spell)
    ...
    elseif spell.en == "Elemental Siphon" then
        ...
        send_command('wait 3.0;input /ma "'..gs_skill.skillup_spells[gs_skill.skillup_count]..'" <t>')
    end
end
