...
sets.TreasureHunter = {gear.th_head,gear.th_waist,gear.th_hands}
...
gear.th_head = {name="Wh. Rarab Cap +1"}
gear.th_waist = {name="Chaac Belt"}
gear.th_hands = {name="Volte Bracers"}
gear.valorous_th_feet = {name="Valorous Greaves", augments={'STR+1','Damage taken-1%','"Treasure Hunter"+1','Accuracy+1 Attack+1','Mag. Acc.+15 "Mag.Atk.Bns."+15',}}
...
gear.herculean_wsd_feet = { name="Herculean Boots", augments={'Attack+12','Weapon skill damage +4%','STR+10',}}
gear.herculean_wsd_head = { name="Herculean Helm", augments={'Weapon skill damage +4%','Accuracy+6','Attack+10',}}
--gear.herculean_wsd_legs = { name="Herculean Trousers", augments={'Attack+27','Weapon skill damage +4%','AGI+8',}}
gear.herculean_ta_feet = { name="Herculean Boots", augments={'"Triple Atk."+4','STR+8','Accuracy+14','Attack+13',}}
...
gear.herculean_wsd_body = { name="Herculean Vest", augments={'Accuracy+21 Attack+21','Weapon skill damage +3%','DEX+2','Accuracy+8','Attack+15',}}
...
gear.merlinic_nuke_head = {name="Merlinic Hood", augments={'Mag. Acc.+11 "Mag.Atk.Bns."+11','Magic burst dmg.+9%','CHR+8','"Mag.Atk.Bns."+9',}}
...
gear.valorous_wsd_head = {name="Valorous Mask", augments={'CHR+14','VIT+4','Weapon skill damage +5%','Accuracy+9 Attack+9','Mag. Acc.+13 "Mag.Atk.Bns."+13',}}
...
gear.valorous_wsd_body = {name="Valorous Mail", augments={'Pet: DEX+14','Pet: "Subtle Blow"+10','Weapon skill damage +5%','Accuracy+4 Attack+4',}}
gear.valorous_wsd_hands = {name="Valorous Mitts", augments={'Pet: Mag. Acc.+28','CHR+3','Weapon skill damage +5%','Accuracy+16 Attack+16','Mag. Acc.+1 "Mag.Atk.Bns."+1',}}
...
gear.valorous_wsd_feet = {name="Valorous Greaves", augments={'"Mag.Atk.Bns."+28','DEX+2','Weapon skill damage +8%',}}