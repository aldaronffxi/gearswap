...
--	state.Weapons:options('Naegling', 'Axe')
	...
	state.JugMode = M{['description']='Jug Mode', 'BouncingBertha','WarlikePatrick','BlackbeardRandy','SwoopingZhivago','VivaciousVickie'}
...
--		sets.weapons.Naegling = {main="Naegling",sub="
	...
	sets.precast.WS = {ammo="Paeapua",
								...
								body=gear.valorous_wsd_body,hands="Meg. Gloves +1",ring1="Karieyh Ring +1",ring2="Ilabrat Ring",
								back="Sacro Mantle",waist="Fotia Belt",legs="Tali'ah Sera. +1",feet=gear.valorous_wsd_feet}

	sets.precast.WS.Acc = {}

		-- Specific weaponskill sets.
	sets.precast.WS['Primal Rend'] = {ammo="Dosis Tathlum",
								head="Tali'ah Turban",neck="Baetyl Pendant",ear1="Crematio Earring",ear2="Friomisi Earring",
								body="Tali'ah Manteel +1",hands="Leyline Gloves",ring1="Shiva Ring +1",ring2="Shiva Ring +1",
								back="Toro Cape",waist="Fotia Belt",legs="Tali'ah Sera. +1",feet="Despair Greaves"}
	...
	sets.idle = {ammo="Staunch Tathlum",
			head="Gavialis Helm",neck="Loricate Torque +1",ear1="Genmei Earring",ear2="Etiolation Earring",
			body="Sacro Breastplate",hands="Ankusa Gloves +1",ring1="Defending Ring",ring2="Cath Palug Ring",
			back="Solemnity Cape",waist="Flume Belt",legs="Tali'ah Sera. +1",feet="Skd. Jambeaux +1"}

	sets.idle.Refresh = set_combine(sets.idle, {})
	sets.idle.Reraise = set_combine(sets.idle, {head="Twilight Helm",body="Twilight Mail"})

	sets.idle.Pet = {ammo="Staunch Tathlum",
			head="Tali'ah Turban",neck="Empath Necklace",ear1="Genmei Earring",ear2="Etiolation Earring",
			body="Sacro Breastplate",hands="Ankusa Gloves +1",ring1="Defending Ring",ring2="Cath Palug Ring",
			back="Artio's Mantle",waist="Flume Belt",legs="Tali'ah Sera. +1",feet="Skd. Jambeaux +1"}

	sets.idle.Pet.Engaged = {ammo="Staunch Tathlum",
			head="Tali'ah Turban",neck="Shulmanu Collar",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
			body="Sacro Breastplate",hands="Tali'ah Gages",ring1="Defending Ring",ring2="C. Palug Ring",
	...
	sets.engaged = {main="Arktoi",ammo="Ginsen",
				head="Tali'ah Turban",neck="Shulmanu Collar",ear1="Brutal Earring",ear2="Suppanomimi",
				body="Tali'ah Manteel +1",hands="Tali'ah Gages",ring1="Hetairoi Ring",ring2="Epona's Ring",
				back="Atheling Mantle",waist="Ioskeha Belt",legs="Tali'ah Sera. +1",feet="Valorous Greaves"}

	sets.engaged.Acc = {ammo="Falcon Eye",
				head=gear.valorous_wsd_head,neck="Lissome Necklace",ear1="Zennaroi Earring",ear2="Brutal Earring",
				body="Tali'ah Manteel +1",hands="Leyline Gloves",ring1="Hetairoi Ring",ring2="Epona's Ring",
	...
	sets.engaged.PDT = {ammo="Staunch Tathlum",
				head="Genmei Kabuto",neck="Sanctity Necklace",ear1="Brutal Earring",ear2="Moonshade Earring",
				body="Tali'ah Manteel +1",hands="Buremte Gloves",ring1="Defending Ring",ring2="Paguroidea Ring",
				back="Moonlight Cape",waist="Ioskeha Belt",legs="Tali'ah Sera. +1",feet="Valorous Greaves"}

	sets.engaged.Acc.PDT = {ammo="Falcon Eye",
				head=gear.valorous_wsd_head,neck="Sanctity Necklace",ear1="Brutal Earring",ear2="Moonshade Earring",
				body="Tali'ah Manteel +1",hands="Buremte Gloves",ring1="Defending Ring",ring2="Paguroidea Ring",
				back="Moonlight Cape",waist="Ioskeha Belt",legs="Tali'ah Sera. +1",feet="Valorous Greaves"}

				-- MELEE (DUAL-WIELD) SETS FOR DNC AND NIN SUBJOB
	sets.engaged.DW = {main="Naegling",ammo="Ginsen",
				head="Tali'ah Turban",neck="Shulmanu Collar",ear1="Sherida Earring",ear2="Suppanomimi",
				body="Tali'ah Manteel +1",hands="Tali'ah Gages",ring1="Hetairoi Ring",ring2="Epona's Ring",
				back="Atheling Mantle",waist="Reiki Yotai",legs="Tali'ah Sera. +1",feet="Tali'ah Crackows +1"}

	sets.engaged.DW.Acc = {main="Naegling",ammo="Ginsen",
				head="Tali'ah Turban",neck="Shulmanu Collar",ear1="Sherida Earring",ear2="Suppanomimi",
				body="Tali'ah Manteel +1",hands="Tali'ah Gages",ring1="Hetairoi Ring",ring2="Epona's Ring",
				back="Atheling Mantle",waist="Reiki Yotai",legs="Tali'ah Sera. +1",feet="Tali'ah Crackows +1"}

				-- MELEE (DUAL-WIELD) HYBRID SETS
		sets.engaged.DW.PDT = set_combine(sets.engaged.PDT, {ear1="Sherida Earring",ear2="Suppanomimi",})
		sets.engaged.DW.Acc.PDT = set_combine(sets.engaged.Acc.PDT, {ear1="Sherida Earring",ear2="Suppanomimi",})
